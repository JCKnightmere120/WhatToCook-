...
const routes: Routes = [
  ...
  { path: 'favorites', canActivate: [AuthGuard], loadChildren: () => import('./favorites/favorites.module').then(m => m.FavoritesPageModule) },
  { path: 'recipes/:id', canActivate: [AuthGuard], loadChildren: () => import('./recipe-detail/recipe-detail.module').then(m => m.RecipeDetailPageModule) },
  ...
  { path: 'cooking/:id', canActivate: [AuthGuard], loadChildren: () => import('./cooking/cooking.module').then(m => m.CookingPageModule) },
  {
    path: '',
    canActivate: [AuthGuard],
