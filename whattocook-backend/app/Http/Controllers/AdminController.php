...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        return view('admin.admindashboard', ['counts' => $counts, 'recentRecipes' => $recentRecipes]);
    }
    ...
    public function users()
    {
        ...
        return view('admin.user.adminuser', ['users' => $users]);
    }
    ...
    public function pantry()
    {
        ...
        return view('admin.pantry.adminpantry', ['items' => $items]);
    }
    ...
    public function categories()
    {
        ...
        return view('admin.categories.admincategories', ['categories' => $categories]);
    }
}
