...
@section('content')
    <section class="dashboard-overview">
        <header class="dashboard-header">
            <div>
                <p class="dashboard-eyebrow">Cook from what you have</p>
    ...
    <style>
        ...
        .dashboard-eyebrow { color: var(--muted); font-size: 11px; font-weight: 800; letter-spacing: .12em; margin: 0 0 8px; text-transform: uppercase; }
        .dashboard-header p:not(.dashboard-eyebrow) { color: var(--muted); }
        .dashboard-card { background: var(--card); border-color: var(--line); border-radius: 12px; box-shadow: 0 12px 30px rgba(0, 0, 0, .18); }
        .dashboard-card h3 { color: var(--muted); }
        .dashboard-card p { color: var(--cream); }
        .recent-recipe-item { background: var(--card) !important; border-color: var(--line) !important; }
        .recent-recipe-item a { color: var(--cream) !important; }
        .recent-recipe-item a:hover { color: var(--green-dark) !important; }
        .recent-recipe-item div { color: var(--muted) !important; }
    </style>
@endsection
