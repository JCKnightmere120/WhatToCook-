    ...
    <div class="recipe-page">
        <div class="recipe-card">
            <header class="recipe-card__header">
                <div>
                    <h1>Create Recipe</h1>
                    <p class="recipe-card__subtitle">Add a new recipe with difficulty, meal type, prep and cook time.</p>
                </div>
            </header>
            ...
            <form action="{{ route('admin.recipes.store') }}" method="POST" class="recipe-form">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group form-group--inline">
                        ...
                        <input id="cook_time" name="cook_time" type="number" min="0" value="{{ old('cook_time') }}">
                    </div>
                </div>

                <div class="form-group form-group--wide">
                    <label for="instructions">Instructions</label>
                    <textarea id="instructions" name="instructions" rows="7" required>{{ old('instructions') }}</textarea>
                </div>
                ...
                <div class="form-group form-group--wide">
                    ...
                    @php
                        $ingredientRows = old('ingredients', [['name' => '', 'quantity' => '', 'unit' => '']]);
                        if (is_string($ingredientRows)) {
                            $decodedIngredients = json_decode($ingredientRows, true);
                            if (is_array($decodedIngredients)) {
                                $ingredientRows = $decodedIngredients;
                            }
                        }
                    @endphp
                ...
                <div class="form-actions">
                    <button type="submit" class="button button--primary">Create recipe</button>
                </div>
            </form>
        </div>
    </div>
